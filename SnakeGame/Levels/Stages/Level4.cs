...
{
    public class Level4 : LevelBase, ILevel
    {
        public Level4(IFoodDrawer foodDrawer, ILayoutDrawer layoutDrawer, IGameOver gameOver) : base(foodDrawer, layoutDrawer, gameOver)
        {
        }
